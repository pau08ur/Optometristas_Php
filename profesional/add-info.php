...
if (isset($_POST['inicial'])) {
  ...
  $cod_lentes = "SELECT codigo from lentes  where descrip = '" . $lentes . "'";
                ...
                <div class="card d-flex justify-content-center mx-auto my-3 p-5">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <input type="text" id="nombre" name="nombre"  maxlength="35" required size="35" onkeypress="nextFocus('nombre', 'edad')">
                      <div id="fname_error" class="val_error"></div>
                    </div>
                    <div class="form-group col-md-6 first">
                      <label for="inputFirstName" class="lbledad">Edad<span>*</span></label>
                      <div class="age"><input type="text" id="edad" maxlength="2"  name="edad" required size="12" onkeypress="nextFocus('edad', 'email')"></div>
                      <div id="fname_error" class="val_error"></div>
                    </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <input type="email" id="email" name="email" maxlength="25"  required size="35" onkeypress="nextFocus('email', 'numero')">
                      <div id="fname_error" class="val_error"></div>
                    </div>
                    <div class="form-group col-md-6 first">
                      <label for="inputFirstName" class="lbledad">Numero<span>*</span></label>
                      <div class="age"><input type="text" id="numero" name="numero" maxlength="10" size="12" onkeypress="nextFocus('numero', 'ocupacion')"></div>
                      <div id="fname_error" class="val_error"></div>
                    </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <input type="text" id="ocupacion" name="ocupacion" maxlength="30"  required size="35" onkeypress="nextFocus('ocupacion', 'cedpaciente2')">
                      <div id="fname_error" class="val_error"></div>
                    </div>
                    <div class="form-group col-md-6 first">
                      <label for="inputFirstName" class="lbledad">Cedula<span>*</span></label>
                      <div class="age"><input type="text" id="cedpaciente2" name="cedpaciente2" maxlength="10"  required size="12" onkeypress="nextFocus('cedpaciente2', 'direccion')"></div>
                      <div id="fname_error" class="val_error"></div>
                    </div>
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <input type="text" id="direccion" name="direccion" maxlength="50"  required size="35" onkeypress="nextFocus('direccion', 'fecha_nacimiento')">
                      <div id="fname_error" class="val_error"></div>
                    </div>
                    <div class="form-group col-md-6 first">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <div class="suc"><select name="sucursal" id="sucursal" required onkeypress="nextFocus('sucursal', 'salud_general')" class="sucur">
                          ...
                          <option value="multiplaza_principal" <?php if ($suc == "multiplaza_principal") {
                                                          echo "selected='selected'";
                                                        } ?>>Multiplaza Principal</option>
                          ...
                          <option value="turrialba" <?php if ($suc == "turrialba") {
                                                  echo "selected='selected'";
                                                } ?>>Turrialba</option>
                          ...
                          <option value="decosure" <?php if ($suc == "decosure") {
                                                  echo "selected='selected'";
                                                } ?>>Decosure</option>
                          ...
                          <option value="clinica_catolica" <?php if ($suc == "clinica_catlica") {
                                                  echo "selected='selected'";
                                                } ?>>Clinica Catolica</option>
                          <option value="pinares" <?php if ($suc == "pinares") {
                                                  echo "selected='selected'";
                                                } ?>>Pinares</option>
                          <option value="perez_zeledon" <?php if ($suc == "perez_zeledon") {
                                                  echo "selected='selected'";
                                                } ?>>Perez Zeledon</option>
                ...
                <div class="card d-flex justify-content-center mx-auto my-3 p-5" style="width: 90%;">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      ...
                      <select name="lentes" id="lentes"style="width: 700px; font-size:smaller; height: 25px; text-align:left" class="sucur">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6 first">
                      <label for="inputFirstName" id="lblar_ultra">Tratamientos<span>*</span></label>
                      <select name="ar_ultra" id="ar_ultra"style="width: 700px; font-size:smaller; height: 25px; text-align:left" class="sucur">
                        <?php
                        //CODIGO PHP Y SQL PARA CARGAR LOS DATOS DE LOS AROS EN UN SELECT 
                        require('abrir.php');
